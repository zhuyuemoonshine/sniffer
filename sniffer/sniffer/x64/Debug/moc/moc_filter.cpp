...
QT_MOC_LITERAL(3, 13, 18), // "std::pair<int,int>"
QT_MOC_LITERAL(4, 32, 8) // "selected"

    },
    "filter\0send\0\0std::pair<int,int>\0"
    "selected"
};
...
void filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send((*reinterpret_cast< std::pair<int,int>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (filter::*)(std::pair<int,int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filter::send)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void filter::send(std::pair<int,int> _t1)
{
