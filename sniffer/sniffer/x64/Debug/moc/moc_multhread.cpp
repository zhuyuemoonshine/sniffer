...
QT_MOC_LITERAL(3, 16, 11), // "DataPackage"
QT_MOC_LITERAL(4, 28, 4) // "data"

    },
    "multhread\0send\0\0DataPackage\0data"
};
...
void multhread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&multhread::send)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject multhread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_multhread.data,
    qt_meta_data_multhread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
